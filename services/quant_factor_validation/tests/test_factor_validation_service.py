...
class FactorValidationServiceTest(unittest.IsolatedAsyncioTestCase):
    async def test_should_validate_factor_and_query_standard_market_fields(self) -> None:
        ...
        request = FactorValidationRequest(
            ...
            factor_values=[
                FactorDailyValue(symbol="000001.SZ", trade_date="2026-03-13", factor_name="momentum_1d", factor_value="0.1"),
                FactorDailyValue(symbol="000002.SZ", trade_date="2026-03-13", factor_name="momentum_1d", factor_value="0.2"),
                FactorDailyValue(symbol="000003.SZ", trade_date="2026-03-13", factor_name="momentum_1d", factor_value="0.3"),
            ],
